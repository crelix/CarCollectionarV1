	    														...
	    														if(Part.parts[21] >0){
	    															if(Part.parts[23] >0){
	    																if(Part.parts[25] >0){
	    																	...
	    																	level1carticker+=4;
	    																	if(CarsLv1.cars[level1carticker] == 0){
	    																		CarFrame.frames[1] = CarFrame.frames[1] - 1;
	    																		Part.parts[1] = Part.parts[1] - 1;
	    																		Part.parts[3] = Part.parts[3] - 1;
	    																		Part.parts[5] = Part.parts[5] - 1;
	    																		...
	    																		Part.parts[25] = Part.parts[25] - 1;
	    																		CarMain.main[7] = CarMain.main[7] - 1;
	    																		int skaitlis = 	(CarsLv1.cars[level1carticker]; skaitlis+=1; 
	    																		CarsLv1.cars[level1carticker] = skaitlis);
	    																	...
	    																	if(CarsLv1.cars[level1carticker] == 0){
	    																		...
	    																		Part.parts[25] = Part.parts[25] - 1;
	    																		CarMain.main[7] = CarMain.main[7] - 1;
	    																		int skaitlis = 	(CarsLv1.cars[3]; skaitlis+=1;  
	    																		CarsLv1.cars[level1carticker] = skaitlis);
		    														...
		    														if(Part.parts[47] >0){
		    															if(Part.parts[49] >0){
		    																if(Part.parts[51] >0){
		    																	...
		    																	if(CarsLv2.cars[level2carticker] == 0){  
		    																		...
		    																		CarMain.main[7] = CarMain.main[7] - 1;
		    																		int skaitlis = 	(CarsLv2.cars[3]; skaitlis+=1; 
		    																		CarsLv2.cars[level2carticker] = skaitlis);
		    																	...
		    																	if(CarsLv2.cars[level2carticker] == 0){  
		    																		...
		    																		Part.parts[51] = Part.parts[51] - 1;
		    																		CarMain.main[7] = CarMain.main[7] - 1;
		    																		int skaitlis = 	(CarsLv2.cars[level2carticker]; skaitlis+=1; 
		    																		CarsLv2.cars[level2carticker] = skaitlis);
		    														...
		    														if(Part.parts[73] >0){
		    															if(Part.parts[75] >0){
		    																if(Part.parts[77] >0){
		    																	...
		    																	if(CarsLv3.cars[level3carticker] == 0){  
		    																		...
		    																		CarMain.main[7] = CarMain.main[7] - 1;
		    																		int skaitlis = 	(CarsLv3.cars[3]; skaitlis+=1; 
		    																		CarsLv3.cars[3] = skaitlis);
		    																	...
		    																	if(CarsLv3.cars[level3carticker] == 0){  
		    																		...
		    																		Part.parts[77] = Part.parts[77] - 1;
		    																		CarMain.main[7] = CarMain.main[7] - 1;
		    																		int skaitlis = 	(CarsLv3.cars[level3carticker]; skaitlis+=1; 
		    																		CarsLv3.cars[level3carticker] = skaitlis);
		    														...
		    														if(Part.parts[99] >0){
		    															if(Part.parts[101] >0){
		    																if(Part.parts[103] >0){
		    																	...
		    																	if(CarsLv4.cars[level4carticker] == 0){  
		    																		...
		    																		CarMain.main[7] = CarMain.main[7] - 1;
		    																		int skaitlis = 	(CarsLv4.cars[3]; skaitlis+=1; 
		    																		CarsLv4.cars[3] = skaitlis);
		    																	...
		    																	if(CarsLv4.cars[level4carticker] == 0){  
		    																		...
		    																		Part.parts[103] = Part.parts[103] - 1;
		    																		CarMain.main[7] = CarMain.main[7] - 1;
		    																		int skaitlis = 	(CarsLv4.cars[level4carticker]; skaitlis+=1; 
		    																		CarsLv4.cars[level4carticker] = skaitlis);
		    														...
		    														if(Part.parts[125] >0){
		    															if(Part.parts[127] >0){
		    																if(Part.parts[129] >0){
		    																	...
		    																	if(CarsLv5.cars[level5carticker] == 0){  
		    																		...
		    																		CarMain.main[7] = CarMain.main[7] - 1;
		    																		int skaitlis = 	(CarsLv5.cars[3]; skaitlis+=1; 
		    																		CarsLv5.cars[3] = skaitlis);
		    																	...
		    																	if(CarsLv5.cars[level5carticker] == 0){  
		    																		...
		    																		Part.parts[129] = Part.parts[129] - 1;
		    																		CarMain.main[7] = CarMain.main[7] - 1;
		    																		int skaitlis = 	(CarsLv5.cars[level5carticker]; skaitlis+=1; 
		    																		CarsLv5.cars[level5carticker] = skaitlis);
